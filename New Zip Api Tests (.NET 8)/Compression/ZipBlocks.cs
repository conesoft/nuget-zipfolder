    ...
    internal struct Zip64ExtraField
    {
            ...
            out Zip64ExtraField zip64Block)
        {
            ...
            using (BinaryReader reader = new BinaryReader(ms))
            {
                ...
                if (zip64Block._uncompressedSize < 0) throw new InvalidDataException();
                if (zip64Block._compressedSize < 0) throw new InvalidDataException();
                if (zip64Block._localHeaderOffset < 0) throw new InvalidDataException();
